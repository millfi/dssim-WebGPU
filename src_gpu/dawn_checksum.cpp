...
std::string BuildJson(
    ...
    os << "{\n";
    os << "  \"schema_version\": 1,\n";
    os << "  \"engine\": \"gpu-dawn-wgsl-dssim-stage3x3-linear\",\n";
    os << "  \"status\": \"ok\",\n";
    os << "  \"input\": {\n";
    ...
    os << "  \"version\": \"dawn-dssim-stage3x3-linear-1\",\n";
    os << "  \"result\": {\n";
    std::ostringstream scoreText;
    scoreText << std::fixed << std::setprecision(8) << compute.score;
    os << "    \"score_source\": \"gpu-stage3x3-ssim-linear-provisional\",\n";
    ...
    os << "    \"gpu_stage0\": {\n";
    os << "      \"metric\": \"dssim_3x3_luma_linear_srgb\",\n";
    os << "      \"color_space\": \"srgb_to_linear\",\n";
    ...
    if (debugInfo != nullptr) {
        ...
        os << "    },\n";
        os << "    \"stage0_dssim3x3_linear_u32le\": {\n";
...
int main(int argc, char** argv) {
    try {
        ...
        if (options.debugDumpEnabled) {
            ...
            debugInfo.stage0DssimPath = options.debugDumpDir / "stage0_dssim3x3_linear_u32le.gpu.bin";
